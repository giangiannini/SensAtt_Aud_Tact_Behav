...
for mm = 1:length(suffixes)
    ...
    matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(i).scans = {
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0001.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0002.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0005.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0006.nii,1')
                                                                                      };
    ...
    for i = 1:length(subjects)
    matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(i).scans = {
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0003.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0004.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0005.nii,1')
                                                                                      strcat('F:\Gian_Polina_2025\02Data\ID', char(subjects(i)), '\02FirstLevel\', '20250606', suffix, '\beta_0006.nii,1')
                                                                                      };
    matlabbatch{1}.spm.stats.factorial_design.des.fblock.fsuball.fsubject(i).conds = [1 1
